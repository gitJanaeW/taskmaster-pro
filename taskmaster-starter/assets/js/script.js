...
var auditTask = function(taskEl){
  ...
  // convert to momnet object at 5:00pm
  var time = moment(date, "L").set("hour", 17); // Stores a var with the local time ("L") configured to 17:00 (5pm)
  // this should print out an object for the value of the date variable, but at 5:00pm of that date
  console.log(time);
  // remove any old classes from taskEl
  $(taskEl).removeClass("list-group-item-warning list-group-item-danger");

// if current time is after 5pm, make taskEl red
...
$("#modalDueDate").datepicker({
  minDate: 1 // Sets the minimum pickable date to be one day from the current date
});
